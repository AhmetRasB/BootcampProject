        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalityIdentity = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blacklists_Users_ApplicantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bootcamp_Dates", "StartDate < EndDate");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ApplicantId_BootcampId",
                table: "Applications",
                columns: new[] { "ApplicantId", "BootcampId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_NationalityIdentity",
                table: "Users",
                column: "NationalityIdentity",
                unique: true);
        }
